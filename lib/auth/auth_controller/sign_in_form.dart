...
import 'package:funciona_peru/auth/auth_controller/firebase_functions.dart';
import 'package:funciona_peru/utils/rive_utils.dart';
          ...
          Future.delayed(
            ...
            () {
              ...
              Future.delayed(
                const Duration(seconds: 1),
                () {
                  signInFirebase(context, emailTextController, passwordTextController);
                  //borrar login
